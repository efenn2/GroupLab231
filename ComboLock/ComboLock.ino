...
void handleKeypress(unsigned long now) {
  if (cowpi_getKeypress() && now - lastKeypadPress > DEBOUNCE_TIME) {
    ...
    if (currentPosition == 7) {
      ...
      display[7] = currentMessage[7] & 0b01111111;
      currentPosition--;
    } else if (currentPosition == 6) {
      currentMessage[6] = keypress | 0x80;
      display[6] = currentMessage[6] & 0b01111111;
      currentPosition++;
    } else if (currentPosition == 4) {
      currentMessage[4] = keypress | 0x80;
      display[4] = currentMessage[4] & 0b01111111;
      currentPosition--;
    } else if (currentPosition == 3) {
      currentMessage[3] = keypress | 0x80;
      display[3] = currentMessage[3] & 0b01111111;
      currentPosition++;
    } else if (currentPosition == 1) {
      currentMessage[1] = keypress | 0x80;
      display[1] = currentMessage[1] & 0b01111111;
      currentPosition--;
    } else {
      currentMessage[0] = keypress | 0x80;
      display[0] = currentMessage[0] & 0b01111111;
      currentPosition++;
    }
